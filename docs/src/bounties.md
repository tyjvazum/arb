...
- The `arb` wallet can send and receive specific satoshis. Additionally,
...
- For more information about ordinal theory, check out the [FAQ](./faq.md) for
  an overview, the
  [BIP](https://github.com/tyjvazum/arb/blob/master/bip.mediawiki) for the
  technical details, and the [arb repo](https://github.com/tyjvazum/arb) for the
  `arb` wallet and block explorer.
